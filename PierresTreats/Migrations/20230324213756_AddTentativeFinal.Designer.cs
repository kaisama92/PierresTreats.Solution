...
namespace PierresTreats.Migrations
{
    ...
    [Migration("20230324213756_AddTentativeFinal")]
    partial class AddTentativeFinal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PierresTreats.Models.User", b =>
                {
            ...
            modelBuilder.Entity("PierresTreats.Models.UserTreat", b =>
                {
                    b.Property<int>("UserTreatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("UserTreatId");

                    b.HasIndex("TreatId");

                    b.HasIndex("UserId");

                    b.ToTable("UserTreats");
                });
            ...
            modelBuilder.Entity("PierresTreats.Models.UserTreat", b =>
                {
                    ...
                    b.HasOne("PierresTreats.Models.User", "User")
                        .WithMany("JoinEntity2")
                        .HasForeignKey("UserId");
